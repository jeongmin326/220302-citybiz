        ...
        <div class="flex-1 bg-black relative overflow-hidden" id="videoContainer">
            ...
            <div class="absolute top-6 left-6 z-20">
                ...
                <div class="flex items-center gap-2 mt-3">
                    ...
                    <span class="text-sm font-medium text-green-400">통화 중</span>
                </div>
            </div>
            ...
            <!-- 연장 알림 배너 (우측 상단) -->
            <div id="extensionBanner" class="absolute top-28 right-6 bg-white/95 backdrop-blur rounded-2xl shadow-lg px-5 py-3 hidden z-30 cursor-pointer hover:bg-white transition-all text-sm font-semibold text-slate-900 flex items-center gap-2" onclick="showExtensionAlert()">
                <span class="text-lg">⏱️</span>
                <span id="bannerText">시간 연장</span>
            </div>
            ...
            <!-- Floating Island 제어 패널 (중앙 하단, 항상 표시) -->
            <div class="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 floating-island">
                <div class="bg-black/80 backdrop-blur-xl rounded-3xl px-6 py-8 flex justify-center gap-3 border border-white/20 shadow-2xl">
                    <!-- 마이크 버튼 -->
                    ...
                    <button id="acceptCallBtn" class="flex flex-col items-center gap-2 px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-2xl font-medium transition-all shadow-lg shadow-green-600/50 border border-green-500/50 backdrop-blur hidden">
                        <i data-lucide="phone-check" class="w-6 h-6"></i>
